...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Anexo 24 - AADD Studio.</title>
        ...
        <link rel="stylesheet" href="<?php echo asset('http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700&subset=all') ?>">
<link rel="stylesheet" href="<?php echo asset('../assets/global/plugins/font-awesome/css/font-awesome.min.css') ?>">
<link rel="stylesheet" href="<?php echo asset('../assets/global/plugins/simple-line-icons/simple-line-icons.min.css') ?>">
<link rel="stylesheet" href="<?php echo asset('../assets/global/plugins/bootstrap/css/bootstrap.min.css') ?>">
<link rel="stylesheet" href="<?php echo asset('../assets/global/plugins/uniform/css/uniform.default.css') ?>">
<link rel="stylesheet" href="<?php echo asset('../assets/global/plugins/bootstrap-switch/css/bootstrap-switch.min.css') ?>">
<link rel="stylesheet" href="<?php echo asset('assets/css/bootstrap.min.css') ?>">


        <!-- END GLOBAL MANDATORY STYLES -->
        <!-- BEGIN THEME GLOBAL STYLES -->
<link rel="stylesheet" id="style_components "href="<?php echo asset('../assets/global/css/components.min.css') ?>">
<link rel="stylesheet" href="<?php echo asset('../assets/global/css/plugins.min.css') ?>">
<!-- END THEME GLOBAL STYLES -->
        <!-- BEGIN THEME LAYOUT STYLES -->
<link rel="stylesheet" href="<?php echo asset('../assets/layouts/layout/css/layout.min.css') ?>">
<link rel="stylesheet" id="style_color" href="<?php echo asset('../assets/layouts/layout/css/themes/darkblue.min.css') ?>">
<link rel="stylesheet" href="<?php echo asset('../assets/layouts/layout/css/custom.min.css') ?>">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item  ">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                ...
                                <span class="title">Importacion</span>
                                <span class="arrow"></span>
                            </a>
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                        ...
                        <li class="nav-item  ">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                ...
                                <span class="title">Exportacion</span>
                                <span class="arrow"></span>
                            </a>
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                        ...
                        <li class="nav-item  ">
                            <a href="{{ url('/venue/create') }}" class="nav-link nav-toggle">
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="ecommerce_{{ url('/home') }}" class="nav-link ">
                                        <i class="icon-home"></i>
                                        <span class="title">Dashboard</span>
                                    </a>
                                </li>
